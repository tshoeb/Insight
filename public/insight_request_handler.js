...
export function InsightRequestHandlerProvider(Private, es, timefilter, serviceSettings, getAppState) {
  ...
  return {
    ...
    handler(vis) {
      ...
      vis.params.fpc = fp;
      const qp = new QueryProcessor(vis.params.index, vis.params.attributes, vis.params.timefield, timefunc, vis.params.realdata, vis.params.filtervals, vis.params.shouldvals, es, dashboardContext, filterBar, getAppState, filterManager);
